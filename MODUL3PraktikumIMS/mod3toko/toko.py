...
folder_bank = '1LhUXLRN8oXn5GZ7O29dykmduijZeFgj4'
bank_done = '1r4dfPe4frIyWFXq8OQO4gCxir0biUU5W'
folder_toko = '1dPlHq3lAM-xMtHmKRbVuRElpwhzZZvNt'
toko_done = '1-ee0AlZj1Zw3j0hy7j7uXaJiEbNuR0hr'
...
while (1):
    ...
    try:
        ...
        while (first_boot):
            try:
                print("-- DOWNLOAD FILE INTEGRATION --")
                ...
                try:
                    for file1 in file_list:
                        if "toko_" in file1['title']:
                            ...
                            for jsonData in json_dict['tb_integrasi']:
                                if (jsonData['operation'] != 'delete'):
                                    ...
                                    if (jsonData['operation'] == 'insert'):
                                        ...
                                        print('- insert data from json file - id_transaksi = %s' % jsonData[
                                            'id_transaksi'])
                                    ...
                                    if (jsonData['operation'] == 'update'):
                                        ...
                                        print('- update data from json file - id_transaksi = %s' % jsonData[
                                            'id_transaksi'])
                                else:
                                    data = []
                                    data.append(jsonData['id_transaksi'])
                            ...
                            os.rename('./' + file1['title'], './tokobackup/' + file1['title'])
                            filename2 = './tokobackup/' + file1['title']
                            file2 = drive.CreateFile({'title': file1['title'], 'parents':
                                [{"kind": "drive#fileLink", "id": toko_done}]})
